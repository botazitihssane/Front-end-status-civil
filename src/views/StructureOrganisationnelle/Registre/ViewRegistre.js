              ...
              <CardBody>
                <Table className="align-items-center table-flush" responsive>
                  <thead className="thead-light">
                    <tr>
                      <th scope="col">ID</th>
                      <th scope="col">Nom registre</th>
                      <th scope="col">Type du registre</th>
                      <th scope="col">Annexe appartenant</th>
                  ...
                  <tbody>
                    {registres.map((registre) => (
                      <tr key={registre.id}>
                        ...
                        <td>{registre.nomRegistre}</td>
                        <td>{registre.typeRegistre}</td>
                        <td>{registre.annexe.nomAnnexe}</td>

                        <td>
                          <div className="d-flex">
                            <IconButton
                              onClick={() => handleEditClick(registre)}
                            >
                              <Edit color="primary" />
                            </IconButton>
                            <IconButton
                              onClick={() => handleDeleteClick(registre.id)}
                            >
                              <GridDeleteIcon color="error" />
                            </IconButton>
                          </div>
